...
namespace Commander.Controllers
{
    ...
    public class CommandsController : ControllerBase
    {
        ...
        [HttpGet("{id}", Name = " ")] //gives the route 
        ...
        public ActionResult UpdateCommand(int id, CommandUpdateDto commandUpdateDto)
        {
            ...
            //take the data from CommandUpdateDto and apply it over commandModelRepo
        ...
        [HttpPatch("{id}")]
        public ActionResult PartialCommandsUpdate(int id, JsonPatchDocument<CommandUpdateDto> jsonPatch)
        {
            var commandModelFromRepo = _repository.GetCommandById(id);
        ...
        public ActionResult DeleteCommand(int id)
        {
            ...
            _repository.DeleteCommands(commandModelFromRepo);
            _repository.SaveChanges();
